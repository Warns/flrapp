...
class ProductDetails extends React.Component{
    ...
    render(){
        ...
        let _screenshot = screenshot && !productRenderDone ? <Animated.Image source={{uri: screenshot }} style={{ position:'absolute', zIndex:2, left:0, top:0, width:'100%', height:SCREEN_DIMENSIONS.height-57, resizeMode:'contain', opacity:_alpha, transform:[{scale:_scale}]}} /> : null;
        let _animatedImage = item && !productRenderDone ? <Animated.Image style={{width: _width, height: _height, top: _top, left: _left, position:'absolute', zIndex:3, resizeMode:'contain'}} source={{uri: item.productImages[sequence].mediumImageUrl }} />: null;
