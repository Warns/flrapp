...
import { SHOW_PRELOADING } from "root/app/helper/Constant";
...
class Phone extends React.Component {
  ...
  _onSubmit = obj => {
    let formattedMobileNumber = Utils.formatMobilePhoneNumber(
      obj.data.mobilePhone
    );
    ...
    let data =
      ...
      "&text=" +
      escape(verificationNumber + " koduyla FLORMAR'a giris yapabilirsin.");
  ...
  _Continue = () => {
    ...
    this.props.dispatch({
      ...
      value: {
        phone: mobileNumber,
        phone_formatted: formattedMobileNumber,
        phone_verification: verificationNumber
      }
    });
  ...
  render() {
    ...
    let phoneNo =
      phone_formatted.substr(1) != 0 ? "0" + phone_formatted : phone_formatted;
        ...
        <View style={{ flex: 1 }}>
          <View style={{ padding: 40, paddingBottom: 20, paddingTop: 20 }}>
            ...
            <Text style={{ color: "#000000", lineHeight: 18, fontSize: 15 }}>
              Flormar olarak kişisel bilgilerinin güvenliğini önemsiyoruz, bu
              nedenle sadece ilk girişinde telefonuna gelen onay kodunu girerek
              telefonunu doğrula.
            </Text>
          </View>
