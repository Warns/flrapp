  ...
  render() {
    ...
    return (
      <TouchableOpacity style={{ ...this.props.wrapperStyle }} activeOpacity={.96} onPress={this._onPress}>
        <View style={[{ alignItems: "center", justifyContent: "center", backgroundColor: boxColorStyle, borderWidth: 1, borderColor: borderColorStyle, height: 48, borderRadius: 3, overflow: 'hidden' }, { ...this.props.containerStyle }]}>
